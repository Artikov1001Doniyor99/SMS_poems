...
import kotlinx.android.synthetic.main.fragment_ota_ona.view.*
 ...
 * Use the [OtaOnaFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OtaOnaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root = inflater.inflate(R.layout.fragment_ota_ona, container, false)

        loadDate()
        contactAdapter = ContactAdapter(requireContext(), contactList)
        root.otaOnaRV.adapter = contactAdapter

        root.otaOnaTXT.text = "OTA-ONA SHE'RLAR"

        root.otaOnaButton.setOnClickListener {
    ...
    private fun loadDate() {
        ...
        contactList.add(
            Contact(
                1, "Quvonaman juda", "Quvonaman juda judayam,\n" +
        ...
        contactList.add(
            Contact(
                2, "Sizga tilaklar hali ko'p", "Sizga tilaklari hali ko'p bisyor,\n" +
        ...
        contactList.add(
            Contact(
                3, "Bu balki siz uchun katta", "Bu balki siz uchun katta sovg'amas, \n" +
        ...
        contactList.add(
            Contact(
                4, "Bugun tug'ilgan kunim", "Bugun tug'ilgan kunim \n" +
        ...
        contactList.add(
            Contact(
                5,
                "Ushbu kunda tilaklar ummon bir olam",
                "Ushbu kunda tilaklarimummon bir olam,\n" +
        ...
        contactList.add(
            Contact(
                6, "Tug'ilgan kuninggiz muborak bo'lsin", "Do'stim baxt iqbol doim yor bo'lsin \n" +
        ...
        contactList.add(
            Contact(
                7, "Doim kulib yuring tabassum bilan", "Doim kulib yuring tabassum bilan.\n" +
    ...
    companion object {
         ...
         * @return A new instance of fragment OtaOnaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OtaOnaFragment().apply {
