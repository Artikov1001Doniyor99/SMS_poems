...
import kotlinx.android.synthetic.main.fragment_soginch.view.soginchRV
...
class TabrikFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root.tabrikRV.adapter = contactAdapter

        root.tabrikTXT.text = "TABRIK SHE'RLAR"

        root.tabrikButton.setOnClickListener {
