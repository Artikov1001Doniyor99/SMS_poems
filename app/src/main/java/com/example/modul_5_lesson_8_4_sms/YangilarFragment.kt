 ...
 * Use the [YangilarFragment.newInstance] factory method to
...
class YangilarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root.YangilarRV.adapter = contactAdapter

        root.yangilatTXT.text = "YANGI SHE'RLAR"

        root.yangilarButton.setOnClickListener {
    ...
    companion object {
         ...
         * @return A new instance of fragment YangilarFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            YangilarFragment().apply {
